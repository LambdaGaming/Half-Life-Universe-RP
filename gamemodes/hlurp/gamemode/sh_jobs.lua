...
HLU_JOB = {
	[1] = { --BMRP Jobs
		...
		},
		{
			...
			Weapons = { "weapon_hlmmod_c_357", "weapon_hlof_shotgun_ch", "st_police_cuffs", "weapon_ram" },
			Max = 1,
			Category = "Security",
			IsCop = true,
			SpawnFunction = function( ply )
		...
		},
		{
			...
			Color = color_blue,
			Models = securitymodels,
			Weapons = { "weapon_hlmmod_c_9mmhandgun", "st_police_cuffs", "weapon_ram" },
			Max = 3,
			Category = "Security",
			IsCop = true,
			SpawnFunction = function( ply )
	...
	[2] = { --City 17 RP Jobs
		...
		},
		{
			...
			Models = leadermodels,
			Weapons = { "weapon_smg1", "weapon_portal_pair" },
			Max = 1,
			Category = "Citizens",
			SpawnFunction = function( ply )
		...
		},
		{
			...
			Weapons = { "st_police_cuffs", "weapon_ram_combine" },
			Max = 1,
			Category = "Combine"
		},
		{
			...
			Weapons = { "weapon_ar2", "weapon_frag", "weapon_ram_combine", "st_police_cuffs" },
			Max = 2,
			Category = "Combine",
			SpawnFunction = function( ply )
		...
		},
		{
			...
			Weapons = { "weapon_frag", "weapon_bp_binoculars", "weapon_ram_combine", "weapon_bp_sniper", "st_police_cuffs", "weapon_pistol", "weapon_medkit" },
			Max = 3,
			Category = "Combine",
			SpawnFunction = function( ply )
		...
		},
		{
			...
			Weapons = { "weapon_frag", "weapon_bp_binoculars", "weapon_ram_combine", "weapon_shotgun", "st_police_cuffs", "weapon_pistol", "weapon_medkit" },
			Max = 3,
			Category = "Combine",
			SpawnFunction = function( ply )
				ply:GiveAmmo( 50, "Buckshot" )
		...
		},
		{
			...
			Color = Color( 128, 128, 128, 255 ),
			Models = { "models/player/combine_soldier.mdl" },
			Weapons = { "weapon_smg1", "weapon_frag", "weapon_bp_flaregun", "weapon_ram_combine", "st_police_cuffs" },
			Max = 4,
			Category = "Combine",
			SpawnFunction = function( ply )
				ply:GiveAmmo( 100, "SMG1" )
		...
		},
		{
			...
			Color = color_black,
			Models = cpmodels,
			Weapons = { "weapon_pistol", "weapon_stunstick", "weapon_bp_flaregun", "weapon_ram_combine", "st_police_cuffs", "weapon_controllable_manhack" },
			Max = 1,
			Category = "Combine",
			IsCop = true,
			SpawnFunction = function( ply )
		...
		},
		{
			...
			Color = color_black,
			Models = cpmodels,
			Weapons = { "weapon_pistol", "weapon_stunstick", "weapon_bp_flaregun", "weapon_ram_combine", "st_police_cuffs" },
			Max = 0,
			Category = "Combine",
			IsCop = true,
			SpawnFunction = function( ply )
	...
	[3] = { --Outland RP Jobs
		...
		},
		{
			...
			Color = Color( 60, 90, 126, 255 ),
			Models = { "models/player/combine_soldier_prisonguard.mdl" },
			Weapons = { "weapon_bp_binoculars", "weapon_ram_combine", "weapon_bp_sniper", "st_police_cuffs", "weapon_pistol", "weapon_medkit" },
			Max = 3,
			Category = "Combine",
			SpawnFunction = function( ply )
				ply:GiveAmmo( 25, "bp_sniper" )
		...
		},
		{
			...
			Color = Color( 128, 128, 128, 255 ),
			Models = { "models/player/combine_soldier.mdl" },
			Weapons = { "weapon_smg1", "weapon_frag", "weapon_bp_flaregun", "weapon_ram_combine", "st_police_cuffs", "weapon_controllable_manhack" },
			Max = 0,
			Category = "Combine",
			SpawnFunction = function( ply )
				ply:GiveAmmo( 100, "SMG1" )
		...
		},
		{
			...
			Color = Color( 30, 0, 0, 255 ),
			Models = { "models/player/combine_soldier.mdl" },
			Weapons = { "weapon_ram_combine", "weapon_shotgun", "st_police_cuffs" },
			Max = 1,
			Category = "Combine",
			SpawnFunction = function( ply )
				ply:GiveAmmo( 50, "Buckshot" )
